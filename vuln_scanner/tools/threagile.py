...
_LIKELIHOOD_SEV = {
    "very-likely": Severity.CRITICAL, "likely": Severity.HIGH,
    "possible": Severity.MEDIUM, "unlikely": Severity.LOW, "very-unlikely": Severity.INFO,
}
    ...
    def run(self, target: str, scan_input: ScanInput) -> ScanResult:
        ...
        try:
            ...
            return ScanResult(tool=self.name, target=target, duration=0.0,
                              status=ScanStatus.FAILED, error="Binary not found: threagile")
        finally:

    ...
    def run(self, target: str, scan_input: ScanInput) -> ScanResult:
        ...
        try:
            ...
            req = urllib.request.Request(
                ...
                data=body,
                headers={"Authorization": _MOBSF_KEY, "Content-Type": f"multipart/form-data; boundary={boundary}"},
            )
            ...
            req2 = urllib.request.Request(
                ...
                data=scan_body,
                headers={"Authorization": _MOBSF_KEY, "Content-Type": "application/x-www-form-urlencoded"},
            )
            ...
            return ScanResult(
                tool=self.name, target=target, duration=time.monotonic() - start, status=ScanStatus.FAILED, error=str(e)
            )
